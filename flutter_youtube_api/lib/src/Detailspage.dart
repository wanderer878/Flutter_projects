...
class Detailspage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final _playlistId = GoRouterState.of(context).extra as Map<String, String?>;
    return Scaffold(
        appBar: AppBar(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Expanded(
              child: Consumer<Authprovider>(
                ...
                if (authProvider.playlistItems[_playlistId['playlistId']] ==
                    null) {
                  return Center(child: CircularProgressIndicator());
                } else {
                  return ListView.builder(
                      itemCount: authProvider
                          .playlistItems[_playlistId['playlistId']]!.length,
                      itemBuilder: (context, index) {
                        final item = authProvider
                            .playlistItems[_playlistId['playlistId']]![index];
