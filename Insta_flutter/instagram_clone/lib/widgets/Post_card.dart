      ...
      child: Column(
        children: [
          ...
          SizedBox(
            ...
            child: Image.network("https://images.unsplash.com/photo-1705651460814-abf3af6eefee?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwzfHx8ZW58MHx8fHx8", fit: BoxFit.cover,),
          ),
          Row(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  padding: EdgeInsets.symmetric(vertical: 4),
                    child: Text("1/27/22024", style: TextStyle(
                      color: secondaryColor,
                      fontSize: 16
                    ),),
                  ),
